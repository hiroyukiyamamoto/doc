...
plot(Z[,index[3]], type="l", lty=2, ylim=c(0,3000)) # 136.075
par(new=T)
plot(Z[,index[6]], type="l", lty=2, ylim=c(0,3000)) # 105.035
par(new=T)
plot(Z[,index[8]], type="l", lty=2, ylim=c(0,3000)) # 108.085

par(new=T)
plot(Z[,index[1]], type="l", ylim=c(0,3000)) # 136.075
par(new=T)
plot(Z[,index[2]], type="l", ylim=c(0,3000)) # 136.075
par(new=T)
plot(Z[,index[4]], type="l", ylim=c(0,3000)) # 136.075
par(new=T)
plot(Z[,index[5]], type="l", ylim=c(0,3000)) # 136.075
