...
file_msp <- "C:/Users/hyama/Documents/msinfo/MSMS_Public_EXP_Pos_VS17.msp" # 72439 spectra
...
for(i in 1:nrow(peaklist)){
  ...
  if(length(swath_data_MS2_RT)>=5){
    ...
    index <- which(abs(targetmz-sp_premz) < 0.01)
